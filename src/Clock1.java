...
public class Clock1 extends JFrame {
    ...
    public static final String path = "D:\\Java Projects\\AlarmClock\\src\\yoru-ni-kakeru-ringtone.mp3";
    ...
    public void initComponents() {
        ...
        jLabel1 = new JLabel();
        jLabel1.setBounds(60, 5, 400, 130);
        jLabel1.setFont(f3);
        ...
        tfh.setFont(new Font("Monospaced Bold", Font.BOLD, 20));
        tfh.setHorizontalAlignment(JTextField.CENTER);
        c.add(tfh);

        tfm = new JTextField();
        tfm.setBounds(165, 215, 50, 40);
        tfm.setFont(new Font("Monospaced Bold", Font.BOLD, 20));
        tfm.setHorizontalAlignment(JTextField.CENTER);
        c.add(tfm);

        tfam = new JTextField();
        tfam.setBounds(230, 215, 50, 40);
        tfam.setFont(new Font("Monospaced Bold", Font.BOLD, 20));
